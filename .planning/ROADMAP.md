...
- [x] 19-01-PLAN.md — explicit read-only catalog adapter, SQLite online backup and disposable fixture lifecycle

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 19-02-PLAN.md — migration 031 normalized evidence/scope/conflict/review schema and readiness v2

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 19-03-PLAN.md — canonical hash v2, four current-hash reviews and atomic publication

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 19-04-PLAN.md — canonical full-inventory ledger, deterministic artifacts and shared audit truth
...
| 21. Taxonomy 与身份归一 | v1.2 | 1/6 | In Progress|  |

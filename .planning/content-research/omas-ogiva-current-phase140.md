# 当代 OMAS Ogiva：2016 断点之后的独立商品

## summary

当代 OMAS Ogiva：2016 断点之后的独立商品 的来源化导航与版本边界；所有规格限定到可核官方 SKU，并以专业二手来源交叉检查，拒绝跨代际、跨材质或跨样本继承。

## body_md

## 身份

本页描述复兴后当前 OMAS Ogiva demonstrator，不把它当作旧公司 Ogiva 的连续批次。当前官方产品和目录给出明确实体参数，可用于购买核验；旧 OMAS 仅作为造型历史背景。
...
当前官方 scope：capped length 151 mm、maximum diameter 14 mm、weight 39.7 g；14K gold nib、ebonite feed、piston filling。数值不回填旧 Ogiva，也不代表所有当前特别版完全相同。
...
2016 年前旧 OMAS/Ogiva 的轻量树脂、celluloid、旧 nib、旧 piston 与售后全部排除。当前颜色、trim 和 limited edition 也按 SKU 分开。
...
- Official primary: OMAS Bologna official current Ogiva page and current English catalog; retrieved 2026-07-22.
- Professional secondary: Fountain Pen Hospital current OMAS Ogiva listing and professional catalog; retrieved 2026-07-22.
...
- Rejected/qualified evidence: 2016 年前旧 OMAS/Ogiva 的轻量树脂、celluloid、旧 nib、旧 piston 与售后全部排除。当前颜色、trim 和 limited edition 也按 SKU 分开。

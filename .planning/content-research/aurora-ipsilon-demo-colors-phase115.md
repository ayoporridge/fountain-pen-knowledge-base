...
# Aurora Ipsilon Demo Colors：六种颜色不是六个可互换标签

Demo Colors 最醒目的信息当然是颜色，但真正需要保存的是颜色与硬件组合之间的边界。Aurora 当前分类页及官方 PDF 在 2026-07-21 检索时，将这条产品描述为 glossy colored resin，并展示 clear grip section。六种颜色分成两组：red、purple、turquoise 对应 chrome trim 与 stainless-steel nib；green、orange、yellow 对应 gold trim 与 gold-plated steel nib。
...
Bertram’s Inkwell 的 Adam L. 于 2020-08-06 发布过 Demo Colors 文章。这是一份 professional_secondary 的 dated record：文章记录 cartridge/converter、steel nib，以及 EF、F、M、B、italic 等尖宽选项；同时提到当时 lineup 与 matching ink gift。它可以帮助理解 2020 年市场呈现，却不能把赠墨写成当前随附物，也不能把当时尖宽当成 2026 全部现行选项。
...
red、purple、turquoise 这一组的共同点是 chrome trim 与 stainless-steel nib；green、orange、yellow 这一组则是 gold trim 与 gold-plated steel nib。颜色词按官方英文保留，是为了避免中文色名带来额外色调解释。图中的红、紫、蓝绿、绿、橙、黄只用于帮助区分六个节点，并不声称屏幕色值等于实物。

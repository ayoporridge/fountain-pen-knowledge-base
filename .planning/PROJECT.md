...
- [ ] 品牌页覆盖起源、关键时间线、产品体系、代表型号、辨识特征和可靠延伸阅读
...
| 公开资格由内容门槛决定，而不是由实体存在决定 | 200 状态和规范 URL 不能证明页面对用户有信息价值 | ✓ 由万宝龙 149 空壳页暴露并确立 |
...
---
*Last updated: 2026-07-15 after starting milestone v1.2 内容百科化与型号扩容*

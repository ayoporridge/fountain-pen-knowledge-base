...
# Phase 497 — separate five additional brand primary media
...
- Dunn + The Dunn-Pen
- S.T. Dupont + Line D Eternity
- Eboya + HOUJU M black
- Kanwrite + Heritage
- Gravitas Pens + Ultemate Vac
...
2. Replace only each brand's shared model path with its own original factual
   SVG, insert an approved Phase 497 source item, and update that brand's
   references.

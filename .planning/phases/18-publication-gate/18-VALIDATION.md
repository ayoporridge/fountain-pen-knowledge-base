...
| 18-01-02 | 01 | 1 | PUB-01, PUB-02 | Missing/draft/stale records fail closed | migration/DB | `pnpm check:publication-gate -- --migration` | ❌ W0 | ⬜ pending |
| 18-01-03 | 01 | 1 | PUB-02, PUB-04 | Critical writes invalidate reviewed revision | DB mutation | `pnpm check:publication-gate -- --invalidation` | ❌ W0 | ⬜ pending |
| 18-01-04 | 01 | 1 | PUB-05 | Publish transition is atomic and rejects blockers | transaction | `pnpm check:publication-gate -- --publish` | ❌ W0 | ⬜ pending |
| 18-02-01 | 02 | 2 | PUB-03, PUB-06 | Detail/API cannot read raw unpublished brand/pen | integration | `pnpm check:public-boundary -- --detail-api` | ✅ existing; extend | ⬜ pending |
| 18-02-02 | 02 | 2 | PUB-03, PUB-06 | Browse/facet/home/by/sitemap use identical universe | parity | `pnpm check:public-boundary -- --discovery` | ✅ existing; extend | ⬜ pending |
| 18-02-03 | 02 | 2 | PUB-03, PUB-06 | Graph/recommend/library/wiki/media aliases are gated | parity | `pnpm check:public-boundary -- --relationships` | ✅ existing; extend | ⬜ pending |
| 18-02-04 | 02 | 2 | PUB-04 | Critical edit/retire is not served from stale cache | integration | `pnpm check:publication-gate -- --cache` | ❌ W0 | ⬜ pending |
| 18-03-01 | 03 | 3 | PUB-01, PUB-02 | Fresh replay, upgrade, idempotency, constraints | migration | `pnpm check:publication-gate -- --migration-full` | ❌ W0 | ⬜ pending |
| 18-03-02 | 03 | 3 | PUB-03, PUB-06 | Every public surface equals `public_entities` | full parity | `pnpm check:public-boundary -- --all` | ✅ existing; extend | ⬜ pending |
| 18-03-03 | 03 | 3 | PUB-02, PUB-03 | Montblanc 149 draft shell is 404 and absent everywhere | browser/API | `pnpm exec playwright test tests/e2e/publication-gate.spec.ts --project=desktop` | ❌ W0 | ⬜ pending |
| 18-03-04 | 03 | 3 | PUB-06 | Non-brand/pen visibility has zero bidirectional diff | regression | `pnpm check:publication-gate -- --compatibility` | ❌ W0 | ⬜ pending |
...
|----------|-------------|------------|-------------------|
| Production remains unchanged during Phase 18 | PUB-06 | Confirms deployment boundary rather than application behavior | Verify no remote migration/deploy command appears in commits or summaries; production URL remains on the pre-phase release |

...
export const PHASE537_WANCHER_BRAND_ID = "eOfD77nOeENN";
const NIBS = [
...
export const PHASE537_TARGETS = [
  {
    key: "black",
    entityId: "phase537-wancher-true-urushi-black",
    slug: "wancher-true-urushi-black",
    canonicalName: "Wancher True Urushi Black",
    title: "True Urushi - Black",
    shortTitle: "True Urushi Black",
    japaneseName: "黒",
    productId: "609110097964",
    createdAt: "2018-02-27",
    publishedAt: "2019-10-24",
    url: "https://www.wancherpen.com/products/dream-pen-true-urushi-black",
    jsonUrl: "https://www.wancherpen.com/products/dream-pen-true-urushi-black.json",
    image: "/images/library/site-original/phase537/wancher/true-urushi-black.svg",
    articleFile: ".planning/content-research/wancher-true-urushi-black-phase537.md",
    variants: [{ name: "Default Title", sku: "WF-UR-DREAM-BLACK", price: "US$500", available: true }],
  ...
  {
    key: "red",
    entityId: "phase537-wancher-true-urushi-red",
    slug: "wancher-true-urushi-red",
    canonicalName: "Wancher True Urushi Red",
    title: "True Urushi - Red",
    shortTitle: "True Urushi Red",
    japaneseName: "朱",
    productId: "609189920812",
    createdAt: "2018-02-27",
    publishedAt: "2019-10-24",
    url: "https://www.wancherpen.com/products/dream-pen-true-urushi-red",
    jsonUrl: "https://www.wancherpen.com/products/dream-pen-true-urushi-red.json",
    image: "/images/library/site-original/phase537/wancher/true-urushi-red.svg",
    articleFile: ".planning/content-research/wancher-true-urushi-red-phase537.md",
    variants: [
      { name: "Without Clip", sku: "WF-UR-DREAM-RED", price: "US$500", available: true },
      { name: "With Chrome-plating Clip +$30", sku: "WF-UR-DREAM-RED-CHCL", price: "US$530", available: true },
      { name: "With Gold-plating Clip +$30", sku: "WF-UR-DREAM-RED-GLCL", price: "US$530", available: true },
    ],
    availability: "official JSON 2026-08-06: all three variants available=true; inventory and page labels are mutable",
  },
  {
    key: "yellow",
    entityId: "phase537-wancher-true-urushi-yellow",
    slug: "wancher-true-urushi-yellow",
    canonicalName: "Wancher True Urushi Yellow",
    title: "True Urushi - Yellow",
    shortTitle: "True Urushi Yellow",
    japaneseName: "Yellow",
    productId: "694973628460",
    createdAt: "2018-03-19",
    publishedAt: "2019-10-24",
    url: "https://www.wancherpen.com/products/dream-pen-true-urushi-yellow",
    jsonUrl: "https://www.wancherpen.com/products/dream-pen-true-urushi-yellow.json",
    image: "/images/library/site-original/phase537/wancher/true-urushi-yellow.svg",
    articleFile: ".planning/content-research/wancher-true-urushi-yellow-phase537.md",
    variants: [
      { name: "Without Clip", sku: "WF-UR-DREAM-YELLOW", price: "US$500", available: false },
      { name: "With Chrome-plating Clip +$30", sku: "WF-UR-DREAM-YELLOW-CHCL", price: "US$530", available: false },
      { name: "With Gold-plating Clip +$30", sku: "WF-UR-DREAM-YELLOW-GDCL", price: "US$530", available: false },
    ],
    availability: "official JSON 2026-08-06: all three variants available=false; unavailable is a retrieval-window inventory state, not a permanent discontinuation claim",
  },
] as const;
export type Phase537Target = (typeof PHASE537_TARGETS)[number];
...
function makePack(target: Phase537Target): CuratedEntityPack {
  const scope = `Wancher ${target.shortTitle} exact product record, Ebonite and Urushi material boundary`;
  const product = web({ key: `wancher-phase537-${target.key}-official-json`, title: `${target.title} | Wancher Official product JSON`, url: target.jsonUrl, registryKey: `wancher-official-${target.key}-phase537-json`, registryName: "Wancher Pen official product record", tier: "primary", independenceGroup: `wancher-official-${target.key}-phase537`, summary: `官方 Shopify product JSON：product id ${target.productId}、exact handle、时间、市场变体、SKU、价格与库存。`, locator: "product id, title, handle, created_at, published_at, variants, price and availability" });
  const productPage = web({ key: `wancher-phase537-${target.key}-official-page`, title: `${target.title} | Wancher Official`, url: target.url, registryKey: `wancher-official-${target.key}-phase537-page`, registryName: "Wancher Pen official product page", tier: "primary", independenceGroup: `wancher-official-${target.key}-phase537`, summary: `官方 exact 页面：${target.title}（${target.japaneseName}）、True Urushi、轮岛手工、规格、包装与市场选项。`, locator: "exact title, Japanese name, True Urushi description, Wajima process, specifications and packaging" });
  const collection = web({ key: `wancher-phase537-${target.key}-collection`, title: "True Urushi Collection | Wancher Official", url: "https://www.wancherpen.com/collections/true-urushi", registryKey: `wancher-official-true-urushi-collection-phase537-${target.key}`, registryName: "Wancher Pen official True Urushi collection", tier: "primary", independenceGroup: `wancher-official-true-urushi-collection-phase537-${target.key}`, summary: "官方集合页把 True Urushi 各色商品作为独立入口，并说明 Ebonite、Natural Urushi 和轮岛背景。", locator: "True Urushi sibling navigation and series description" });
  const care = web({ key: `wancher-phase537-${target.key}-care`, title: "Wancher Product Care Guide", url: "https://www.wancherpen.com/pages/product-care", registryKey: `wancher-official-product-care-phase537-${target.key}`, registryName: "Wancher Pen official product care", tier: "primary", independenceGroup: `wancher-official-product-care-phase537-${target.key}`, summary: "官方护理页提供 Ebonite 的浸水、日照、干燥环境和化学清洁剂边界。", locator: "Ebonite care instructions" });
  const wajima = web({ key: `wajimanuri-phase537-${target.key}`, title: "The production process of Wajimanuri", url: "https://www.wajimanuri.co.jp/e_tayashikkiten/process.html", registryKey: `wajimanuri-process-phase537-${target.key}`, registryName: "Wajimanuri professional craft guide", tier: "professional_secondary", independenceGroup: `wajimanuri-process-phase537-${target.key}`, summary: "轮岛工艺资料解释底涂、研磨、反复上漆、干燥与专业分工，只作背景。", locator: "Wajimanuri process stages and specialist craft context" });
  const government = web({ key: `japan-government-wajima-phase537-${target.key}`, title: "Highlighting Japan: Wajima lacquerware", url: "https://www.gov-online.go.jp/eng/publicity/book/hlj/html/202101/202101_05_en.html", registryKey: `japan-government-wajima-phase537-${target.key}`, registryName: "Government of Japan public information", tier: "professional_secondary", independenceGroup: `japan-government-wajima-phase537-${target.key}`, summary: "日本政府资料说明轮岛漆艺多阶段工序与分工，不替本支补写配方或工匠。", locator: "Wajima lacquerware history and craft context" });
  const svg = diagram(`wancher-phase537-${target.key}-svg`, `${target.shortTitle} 材料、变体与来源边界事实图`, target.image);
  ...
  const claims: CuratedClaim[] = [
    ...
    c("name", "product_name", `官方英文标题为 ${target.title}，页面还使用 ${target.japaneseName}；名称只对应 exact product page，不与其他颜色入口合并。`, productPage, "exact title and Japanese product naming"),

...
export const PHASE142_BRANDS = {
  franklinChristoph: "phase142-brand-franklin-christoph",
  birmingham: "phase142-brand-birmingham-pen-company",
} as const;

export const PHASE142_IDS = {
  model20: "phase142-franklin-christoph-model-20-marietta",
  aluminaModelC: "phase142-birmingham-alumina-model-c",
} as const;

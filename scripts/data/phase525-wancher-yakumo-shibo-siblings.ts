...
export const PHASE525_WANCHER_BRAND_ID = "eOfD77nOeENN";

export const PHASE525_TARGETS = [
  {
    key: "yakumo-shibo-sazanami",
    entityId: "phase525-wancher-yakumo-shibo-sazanami",
    slug: "wancher-yakumo-nuri-shibo-urushi-sazanami",
    canonicalName: "Wancher Yakumo-nuri Shibo Urushi - Sazanami Fountain Pen",
    title: "Yakumo-nuri Shibo Urushi - Sazanami Fountain Pen",
    shortTitle: "Yakumo-nuri Shibo Urushi Sazanami",
    productId: "8766010589399",
    createdAt: "2024-11-20",
    url: "https://www.wancherpen.com/products/yakumo-nuri-mon-urushi-sazanami",
    jsonUrl: "https://www.wancherpen.com/products/yakumo-nuri-mon-urushi-sazanami.json",
    image: "/images/library/site-original/phase525/wancher/yakumo-shibo-sazanami.svg",
    articleFile: ".planning/content-research/wancher-yakumo-shibo-urushi-sazanami-phase525.md",
    material: "Ebonite、Yakumo-nuri、Shibo Urushi",
    art: "Yakumo-nuri、Shibo Urushi（纹漆）",
    theme: "深蓝海面上的雨滴波纹主题",
    fill: "Converter 或 European International Standard cartridge",
    sku: "WF-MOUR-DR-YAK-BL",
    price: "US$600",
    nibOptions: [
    ...
    themeText: "Sazanami 把雨滴落在深蓝海面形成的细小波纹转成 Shibo Urushi 的蓝色纹样。",
  },
  {
    key: "yakumo-shibo-homura",
    entityId: "phase525-wancher-yakumo-shibo-homura",
    slug: "wancher-yakumo-nuri-shibo-urushi-homura",
    canonicalName: "Wancher Yakumo-nuri Shibo Urushi - Homura Fountain Pen",
    title: "Yakumo-nuri Shibo Urushi - Homura Fountain Pen",
    shortTitle: "Yakumo-nuri Shibo Urushi Homura",
    productId: "8766016061655",
    createdAt: "2024-11-20",
    url: "https://www.wancherpen.com/products/yakumo-nuri-mon-urushi-homura",
    jsonUrl: "https://www.wancherpen.com/products/yakumo-nuri-mon-urushi-homura.json",
    image: "/images/library/site-original/phase525/wancher/yakumo-shibo-homura.svg",
    articleFile: ".planning/content-research/wancher-yakumo-shibo-urushi-homura-phase525.md",
    material: "Ebonite、Yakumo-nuri、Shibo Urushi",
    art: "Yakumo-nuri、Shibo Urushi（纹漆）",
    theme: "火焰变化与创造力主题",
    fill: "Converter 或 European International Standard cartridge",
    sku: "WF-MOUR-DR-YAK-OR",
    price: "US$600",
    nibOptions: [
      ["jowo", "#6 JoWo stainless steel", "官方尖面菜单。"],
      ["wancher-18k", "Wancher 18K gold", "官方尖面菜单。"],
    ...
    themeText: "Homura 以火焰的破坏力、创造力和持续变化作为 Shibo Urushi 的设计主题。",
  },
  {
    key: "yakumo-shibo-shinra",
    entityId: "phase525-wancher-yakumo-shibo-shinra",
    slug: "wancher-yakumo-nuri-shibo-urushi-shinra",
    canonicalName: "Wancher Yakumo-nuri Shibo Urushi - Shinra Fountain Pen",
    title: "Yakumo-nuri Shibo Urushi - Shinra Fountain Pen",
    shortTitle: "Yakumo-nuri Shibo Urushi Shinra",
    productId: "8766019272919",
    createdAt: "2024-11-20",
    url: "https://www.wancherpen.com/products/yakumo-nuri-mon-urushi-shinra",
    jsonUrl: "https://www.wancherpen.com/products/yakumo-nuri-mon-urushi-shinra.json",
    image: "/images/library/site-original/phase525/wancher/yakumo-shibo-shinra.svg",
    articleFile: ".planning/content-research/wancher-yakumo-shibo-urushi-shinra-phase525.md",
    material: "Ebonite、Yakumo-nuri、Shibo Urushi",
    art: "Yakumo-nuri、Shibo Urushi（纹漆）",
    theme: "深绿自然与森罗万象主题",
    fill: "Converter 或 European International Standard cartridge",
    sku: "WF-MOUR-DR-YAK-GR",
    price: "US$600",
    nibOptions: [
      ["jowo", "#6 JoWo stainless steel", "官方尖面菜单。"],
      ["wancher-18k", "Wancher 18K gold", "官方尖面菜单。"],
    ...
    themeText: "Shinra 以深绿自然和森罗万象为主题，借透明漆与纹样的变化表现时间感。",
  },
] as const;

export type Phase525Target = (typeof PHASE525_TARGETS)[number];
...
function diagram(key: string, title: string, url: string): CuratedSource {
  return {
    key,
    registryKey: "fountain-pen-graph-editorial-phase525",
    registryName: "Fountain Pen Graph editorial studio",
    sourceType: "user_submission",
    tier: "primary",
    independenceGroup: "fountain-pen-graph-editorial-phase525",
    title,
    url,
    homepageUrl: "/",
    itemType: "image",
...
function makePack(target: Phase525Target): CuratedEntityPack {
  const scope = `Wancher ${target.shortTitle} exact product record, Yakumo-nuri Shibo Urushi technique and configuration`;
  const product = web({
    key: `wancher-phase525-${target.key}-official-json`,
    title: `${target.title} | Wancher Official product JSON`,
    url: target.jsonUrl,
    registryKey: `wancher-official-${target.key}-phase525`,
    registryName: "Wancher Pen official product record",
    tier: "primary",
    independenceGroup: `wancher-official-${target.key}-phase525`,
  ...
  const productPage = web({
    key: `wancher-phase525-${target.key}-official-page`,
    title: `${target.title} | Wancher Official`,
    url: target.url,
    registryKey: `wancher-official-${target.key}-page-phase525`,
    registryName: "Wancher Pen official product page",
    tier: "primary",
    independenceGroup: `wancher-official-${target.key}-phase525`,
    summary: `官方商品页：${target.theme}、Shibo Urushi 工艺、手工差异、规格、包装和护理提示。`,
    locator: "exact title, craft narrative, specifications, packaging and care",
  });
  const collection = web({
    key: `wancher-phase525-${target.key}-collection`,
    title: "Yakumo-nuri Urushi Fountain Pen Collection | Wancher Official",
    url: "https://www.wancherpen.com/collections/yakumo-nuri",
    registryKey: `wancher-official-yakumo-nuri-collection-phase525-${target.key}`,
    registryName: "Wancher Pen official Yakumo-nuri collection",
    tier: "primary",
    independenceGroup: `wancher-official-yakumo-nuri-collection-phase525-${target.key}`,
    summary: "官方 Yakumo-nuri 集合页把 Sazanami、Homura、Shinra 与 Ryuusei、Chijimi 等 exact 商品分开导航。",
    locator: "collection product navigation and series boundary",
  });
  const nibGuide = web({
    key: `wancher-phase525-${target.key}-nib-guide`,
    title: "Wancher Fountain Pen Nib Guide",
    url: "https://www.wancherpen.com/pages/nib-guide",
    registryKey: `wancher-official-nib-guide-phase525-${target.key}`,
    registryName: "Wancher Pen official nib guide",
    tier: "primary",
    independenceGroup: `wancher-official-nib-guide-phase525-${target.key}`,
    summary: "官方指南提供 JoWo、Wancher gold、Keiryu/Kodachi 菜单语境；不替 exact page 添加未列组合。",
    locator: "nib family and compatibility guidance",
  });
  const care = web({
    key: `wancher-phase525-${target.key}-care`,
    title: "Wancher Product Care Guide",
    url: "https://www.wancherpen.com/pages/product-care",
    registryKey: `wancher-official-product-care-phase525-${target.key}`,
    registryName: "Wancher Pen official product care",
    tier: "primary",
    independenceGroup: `wancher-official-product-care-phase525-${target.key}`,
    summary: "官方护理页提供漆面和钢笔清洁边界；本包不补写页面没有公布的化学配方。",
    locator: "material care and cleaning guidance",
  });
  const artisan = web({
    key: `shimane-yakumo-context-phase525-${target.key}`,
    title: "八雲塗 | 島根県伝統工芸",
    url: "https://www.pref.shimane.lg.jp/industry/syoko/sangyo/dentou_kougei/kougei/kougei_02.html",
    registryKey: `shimane-pref-yakumo-phase525-${target.key}`,
    registryName: "Shimane Prefecture",
    sourceType: "official",
    tier: "professional_secondary",
    independenceGroup: `shimane-pref-yakumo-phase525-${target.key}`,
    summary: "岛根县官方资料说明八雲塗的明治时期起源、材料与基本工序；只作区域工艺背景。",
    locator: "Yakumo-nuri history, materials and process",
  });
  const museum = web({
    key: `shimane-museum-yakumo-context-phase525-${target.key}`,
    title: "Shimane Art Museum collection and crafts",
    url: "https://www.shimane-art-museum.jp/en/collection/",
    registryKey: `shimane-art-museum-yakumo-phase525-${target.key}`,
    registryName: "Shimane Art Museum",
    sourceType: "official",
    tier: "professional_secondary",
    independenceGroup: `shimane-art-museum-yakumo-phase525-${target.key}`,
  ...
  const c = (
    ...
    predicate: string,
    text: string,
    source: CuratedSource = product,
    locator = "exact product record",
    factClass: "core" | "editorial" = "core",
  ) => claim(`${target.key}-${key}`, predicate, text, source.key, locator, scope, factClass);
  const marketText = `Default Title（${target.sku}）${target.price}`;
  const variants: CuratedVariant[] = [
    {
      key: `${target.key}-handcrafted-surface`,
      name: "Handcrafted surface · no fixed texture standard",
      notes: "官方手工差异提醒；不是限量编号或额外市场 SKU。",
      sourceKey: productPage.key,
    ...
    },
    {
      ...
      name: "Default Title",
      notes: `官方 exact JSON 市场变体，SKU ${target.sku}；价格以当次记录为准。`,
      sourceKey: product.key,
      variantKind: "market_sku",
      productCode: target.sku,
      market: "global",
    },
    ...target.nibOptions.map((item) => ({
      key: `${target.key}-${item[0]}`,
      name: item[1],
      notes: item[2],
      sourceKey: product.key,
  ...
  const claims: CuratedClaim[] = [
    ...
    c("theme", "design_theme", target.themeText, productPage, "exact design narrative"),
    c("craft", "decoration_technique", "Shibo Urushi 先以金属粉在 Urushi 基层上形成图案，再覆盖漆层、刮显并研磨，使纹样从透明漆下显现；不能把主题隐喻写成材料或颜色标准。", productPage, "Shibo Urushi process narrative"),
    c("artisan", "artisan", "官方把 Yakumo-nuri 合作工艺师写为 Nagaya Momoko；区域资料只作背景，不替本支建立逐支签名档案。", productPage, "artisan attribution and identity boundary"),
    ...
    c("nib", "nib", `官方 exact page 列 ${target.nibOptions.map((item) => item[1]).join("、")}；这是尖面菜单，不把未展开组合写成额外市场 SKU。`, product, "nib option menu"),
    c("feed", "feed", `Feed 菜单包括 ${target.feedOptions.map((item) => item[1]).join("、")}；页面说明 ebonite feed 只与 JoWo #6 配用。`, product, "feed options and compatibility"),
    ...
    c("selection", "selection_guidance", `选购或二手核对完整标题、产品编号 ${target.productId}、handle、SKU ${target.sku}、材料与工艺、所选 nib/feed、供墨标准、木盒、pen kimono 和实物照片；不要从其他漆艺商品补未公布字段。`, product, "exact identity and evidence boundary", "editorial"),
  ];
  return {
    key: `phase525-wancher-${target.key}-v1`,
    ...
    scopes: [
      {
        ...
        market: "global",
        nibScope: target.nibOptions.map((item) => item[1]).join("、"),
        materialScope: `${target.material}；未公布漆层数量、批次、尺寸和实测重量。`,
        editionScope: "Default Title 市场变体与手工纹理差异不是公开限量编号；库存和标签按当次页面核对。",
      },
      {
        key: `phase525-${target.key}-context`,
        scopeKey: `phase525-${target.key}-context`,
        productionState: "historical",
        materialScope: "Independent craft context only; no product-specific authenticity certification.",
        editionScope: "工艺叙事不建立独立首发年份或二手价值。",
      },
    ],
    claims,
    variants,
    spec: {
      brandEntityId: PHASE525_WANCHER_BRAND_ID,
      values: {
    ...
    timeline: [{
      key: `${target.key}-listing`,
      title: `${target.shortTitle} exact product record verified`,
      eventType: "design_milestone",
      startDate: RETRIEVED,
      circa: false,
      description: `Exact title, product id, SKU and craft configuration verified on ${RETRIEVED}; this is not a formal release date.`,
      sourceKey: product.key,
    }],
    conflicts: [
      {
        key: `${target.key}-status-window`,
        fieldKey: "status",
        scopeKey: scope,
        conflictKind: "field",
        status: "resolved",
        resolutionNote: "商品标签和库存会随页面更新；保留检索窗口语境，不推断长期可购买或永久停产。",
        members: [{ citationKey: `${target.key}-status`, assertedValue: "exact JSON commercial labels" }],
      },
      {
        key: `${target.key}-not-release-year`,
        fieldKey: "release_year",
        scopeKey: scope,
        conflictKind: "field",
        status: "resolved",
        resolutionNote: "created_at 与工艺故事不足以确定正式首发日；release_year 只保留商品记录时间。",
        members: [{ citationKey: `${target.key}-release`, assertedValue: `created_at ${target.createdAt} is not a formal launch date` }],
      },
    ],
    media: [{
      key: `${target.key}-svg`,
      title: `${target.shortTitle} 材料、配置与护理边界图（非产品照片）`,
      sourceKey: svg.key,
      localPath: svg.url,
      author: "Fountain Pen Graph editorial",
      license: "site-original",
...
export const phase525WancherYakumoShiboPacks: CuratedEntityPack[] = PHASE525_TARGETS.map(makePack);

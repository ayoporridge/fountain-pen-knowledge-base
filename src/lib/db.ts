...
const PUBLICATION_SCHEMA_MANIFEST_V3 = [
  ...
  ["trigger", "entity_content_review_legacy_insert_guard"],
  ["trigger", "entity_content_review_legacy_update_guard"],
  ["trigger", "entity_content_review_legacy_delete_guard"],
  ["trigger", "model_variant_parent_insert_guard"],
  ["trigger", "model_variant_parent_update_guard"],
  ["trigger", "model_variant_parent_owner_update_guard"],

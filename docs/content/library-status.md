...
- stories: 320（seed 基线为 4，含后续品牌/型号故事草稿和研究队列草稿）
- claims: 390（seed 基线为 12，含后续来源、故事、型号档案、图示引用和研究队列 claims）
- citations: 1274（seed 基线为 26，含后续来源、故事、型号档案、图示引用和研究队列引用）
...
- exhibits: 6
- source_items: 684（seed 基线为 15，含后续导入来源索引、官方/二级型号档案、二级品牌资料、研究缺口入口和 Warm Pen Atlas 图像来源项）
...
- Snowhite FP20：`story-model-snowhite-fp20-research`，明确提示钢尖、墨囊/直液和文具渠道定位都需要产品或目录来源。
- Pilot 78G/78G+：`story-model-pilot-78g-research`，明确提示 78G、78G+、学生党口碑和低价神话需要分层核验。
- Pilot 845 Urushi：`story-model-pilot-845-urushi-research`，明确提示旗舰感、漆面材质和与 823/149 的比较需要来源。
- Pilot 88G：`story-model-pilot-88g-research`，明确提示它与 78G 系谱的关系待核验。
- Pilot 912：`story-model-pilot-custom-912-research`，明确提示 PO/FA 等特殊尖讨论需要官方笔尖选项和评测来源。
- Pilot Capless/Decimo：`story-model-pilot-capless-decimo-research`，明确提示 Capless、Vanishing Point、Decimo 命名和按动机制需要分层处理。
- Pilot Cavalier：`story-model-pilot-cavalier-research`
- Pilot Custom 74：`story-model-pilot-custom-74-research`，明确提示入门金笔定位、渠道价和涨价传闻都需要归因。
- Pilot Custom 742：`story-model-pilot-custom-742-research`，明确提示 FA 弹性尖和“823 平价版”说法需要来源。
- Pilot Custom 743：`story-model-pilot-custom-743-research`
- Pilot Custom 823：`story-model-pilot-custom-823-research`，明确提示真空上墨、日用旗舰口碑、清洗难度和颜色版本需要分层证据。
- Pilot Elite 95S：`story-model-pilot-elite-95s-research`，明确提示 Elite 95S/E95S 命名、嵌入式笔尖和短钢笔便携性需要来源。
- Pilot Heritage 91：`story-model-pilot-heritage-91-research`，明确提示它与 Custom 74 的关系、同尖说法和渠道价需要来源。
- Pilot Heritage 92：`story-model-pilot-heritage-92-research`，明确提示活塞金尖身份、透明笔身和 669 起等价格需要来源。
- Pilot Iroshizuku 色彩雫：`story-model-pilot-iroshizuku-reclassification-research`，明确提示这是待重分类墨水条目，不应当作钢笔型号写规格。
- Pilot Prera：`story-model-pilot-prera-research`
- Pilot Kakuno 笑脸：`story-model-pilot-kakuno-research`，明确提示笑脸笔尖、儿童/学生定位和练字推荐需要来源。
- Pilot Cocoon 贵妃：`story-model-pilot-cocoon-research`，明确提示 Cocoon/Metropolitan 命名边界和轻商务定位需要来源。
- Pelikan M1000：`story-model-pelikan-m1000-research`，明确提示旗舰尺寸、手感争议和 M800 对比需要来源。
- Pelikan M1005 Stresemann：`story-model-pelikan-m1005-stresemann-research`
- Pelikan M200：`story-model-pelikan-m200-research`
- Pelikan M400：`story-model-pelikan-m400-research`，明确提示德式湿润书写、性价比争议和 Custom 823 比较需要归因。
- Pelikan M600：`story-model-pelikan-m600-research`
- Pelikan M605 白乌龟：`story-model-pelikan-m605-white-research`，明确提示白乌龟是中文玩家昵称，官方色名和供货状态待核验。
- Pelikan M815：`story-model-pelikan-m815-research`，明确提示 M800 级别特殊版本、金属条纹、18K 笔尖和高价位都需要直接来源。
- Pelikan P457：`story-model-pelikan-p457-research`，明确提示型号身份和 Safari 对比都需要先核验。
- Pelikan Souveran M800：`story-model-pelikan-m800-research`，明确提示尺寸主轴、笔尖、活塞和 M600/M1000 对比需要来源。
- Visconti Rembrandt：`story-model-visconti-rembrandt-research`，明确提示艺术线定位、材质、钢尖和价位需要来源。
- Visconti Van Gogh：`story-model-visconti-van-gogh-research`，明确提示画作配色叙事和产品事实需要分层核验。
- Hero 100：`story-model-hero-100-research`，明确提示国产金尖地位、14K、价格和气密争议需要归因。
- Hero 329：`story-model-hero-329-research`，明确提示低价国货定位和品控稳定性需要来源。
- Hero 616：`story-model-hero-616-research`，明确提示集体记忆、Parker 51 式语境、调试版建议和品控风险需要分开写。
- Faber-Castell Ambition：`story-model-faber-castell-ambition-research`，明确提示材质版本、钢尖和价位需要来源。
- Faber-Castell E-Motion：`story-model-faber-castell-e-motion-research`，明确提示物件感、重量、材质和笔尖体验需要分层归因。
- Faber-Castell Ondoro 烟熏橡木：`story-model-faber-castell-ondoro-smoked-oak-research`，明确提示木材、切面、规格和供货状态待核验。
- Graf von Faber-Castell Classic：`story-model-gvfc-classic-research`，明确提示高端材质、金尖、装配精度和定位需要来源。
- Faber-Castell Neo Slim：`story-model-faber-castell-neo-slim-research`，明确提示细身设计、外观做工、笔尖弹性和上墨方式需要来源。
- Faber-Castell Loom：`story-model-faber-castell-loom-research`，明确提示钢尖口碑、260 周年限量版和价格说法需要归因。
- Jinhao 10：`story-model-jinhao-10-research`，明确提示 50 元惊喜、做工、笔尖和上墨方式需要核验。
- Jinhao 313：`story-model-jinhao-313-research`，明确提示 5-15 元低价入门、钢尖、墨囊和学生场景需要来源。
- Jinhao 619：`story-model-jinhao-619-research`，明确提示班级团购、1688 批发 3 元、渠道和品控需要来源。
- Jinhao 75：`story-model-jinhao-75-research`，明确提示 10-30 元日用入口、钢尖和上墨方式待核验。
- Jinhao 80：`story-model-jinhao-80-research`，明确提示细尖日用、小字场景和外观讨论需要分层处理。
- Jinhao 82：`story-model-jinhao-82-research`，明确提示手帐配色、低价玩具笔和热门监控说法需要归因。
- Jinhao 85：`story-model-jinhao-85-research`，明确提示暗尖、Parker 51 式讨论和低价日用场景需要来源。
- Jinhao 86：`story-model-jinhao-86-research`，明确提示平价日写矩阵、规格和品控评价待核验。
- Jinhao 9035：`story-model-jinhao-9035-research`，明确提示材质版本、规格和价格带需要来源。
- Jinhao 9056 木杆：`story-model-jinhao-9056-wood-research`，明确提示低价实木笔杆、材质和价格判断需要核验。
- Jinhao 911：`story-model-jinhao-911-research`，明确提示 10-30 元日用、钢尖、上墨方式和品控评价需要来源。
- Jinhao 992：`story-model-jinhao-992-research`，明确提示三块钱可用钢笔、透明塑料和耐用性说法需要来源。
- Jinhao X159/159：`story-model-jinhao-x159-159-research`，明确提示海外爆款、大笔身、型号差异和 149 对比需要归因。
- Jinhao Century/100：`story-model-jinhao-century-research`，明确提示金豪王牌、大明尖、79 元价格和透明镂空版本需要版本树核验。
- Jinhao 纯银镂空世纪：`story-model-jinhao-silver-hollow-century-research`，明确提示银饰元素、镂空结构和不到 100 元价格需要谨慎核验。
- Cross Bailey Light：`story-model-cross-bailey-light-research`，明确提示品牌溢价、轻量笔身、91 元价格和做工评价需要分层归因。
- Cross 莎士比亚：`story-model-cross-shakespeare-research`，明确提示“莎士比亚”是否为稳定型号名仍待核验。
- Eversharp Kimberly：`story-model-eversharp-kimberly-research`，明确提示 Richard's Pens profile 是入口，商业背景、广告和规格需要复核。
- Moore Non-Leakable：`story-model-moore-non-leakable-research`，明确提示防漏结构、profile 和维修资料需要分层引用。
...
- Dunn-Pen：`story-model-dunn-pen-research`，明确提示品牌、型号、广告和泵式/无墨囊结构需要拆开复核。
- Esterbrook Dollar Pen：`story-model-esterbrook-dollar-pen-research`，明确提示 Dollar Pen 的价位语境、笔尖系统和版本需要来源。
- Esterbrook Model J Family：`story-model-esterbrook-model-j-family-research`，明确提示 Re-New-Point、尺寸家族和上墨版本边界需要分层处理。
- Eversharp Bantam：`story-model-eversharp-bantam-research`，明确提示小型钢笔、口袋笔/礼品市场线索和规格需要复核。
- Eversharp Coronet：`story-model-eversharp-coronet-research`，明确提示装饰艺术语境、饰面和材料需要复核。
- Eversharp Doric：`story-model-eversharp-doric-research`，明确提示多面造型、可调笔尖和上墨版本需要独立来源。
- Eversharp Envoy：`story-model-eversharp-envoy-research`，明确提示后期产品线位置和“被遗忘型号”叙事需要复核。
- Eversharp Fifth Avenue and Sixty Four：`story-model-eversharp-fifth-avenue-sixty-four-research`，明确提示两个名称/版本边界不能混同。
- Eversharp Pacemaker：`story-model-eversharp-pacemaker-research`，明确提示产品线位置、广告和规格需要复核。
- Eversharp Skyline Family：`story-model-eversharp-skyline-family-research`，明确提示设计语境、尺寸/饰面家族和具体设计师说法需要复核。
- Eversharp Symphony Family：`story-model-eversharp-symphony-family-research`，明确提示战后设计语境、版本和时间线需要补证。
- Eversharp Ventura Family：`story-model-eversharp-ventura-family-research`，明确提示 Pennant/article 语境、晚期产品线位置和规格需要分层引用。
- Ingersoll Dollar Pen：`story-model-ingersoll-dollar-pen-research`，明确提示一美元市场定位、广告和实物规格需要复核。
- J. G. Rider Fountain Pen：`story-model-jg-rider-fountain-pen-research`，明确提示品牌实体暂缺，制造商归属、早期上墨机制和规格需要复核。
- John Hancock Cartridge Pen：`story-model-john-hancock-cartridge-pen-research`，明确提示品牌实体暂缺，早期 cartridge 概念不能直接套用现代墨囊。
- Moore Finger Tip：`story-model-moore-finger-tip-research`，明确提示 Finger Tip 指触概念、按钮/控制结构和战后版本需要来源。
- Parker 21：`story-model-parker-21-vintage-research`，明确提示 vintage Parker 21 与 Parker 51 光环、暗尖和上墨版本需要分开。
- Parker 51 vintage：`story-model-parker-51-vintage-research`，明确提示当前摘要残留翻译指令，旧款 Parker 51 与现代复刻不能混写。
- Parker 180：`story-model-parker-180-research`，明确提示双面书写笔尖、上墨和饰面版本需要复核。
- Parker 45：`story-model-parker-45-research`，明确提示墨囊/上墨器系统、可拆换笔尖和年代定位需要来源。
- Parker 61：`story-model-parker-61-research`，明确提示毛细上墨、暗尖和后续版本差异需要机制来源。
- Parker 75：`story-model-parker-75-research`，明确提示可调笔尖角度、银格纹/饰面和产地版本需要来源。
- Parker Duofold vintage：`story-model-parker-duofold-vintage-research`，明确提示 vintage Duofold 与现代 Centennial/International 产品线分开。
- Parker Duofold Geometric Toothbrush：`story-model-parker-duofold-geometric-toothbrush-research`，明确提示 Toothbrush 昵称、几何纹样和目录身份需要复核。
- Parker Parkette and Writefine：`story-model-parker-parkette-writefine-research`，明确提示经济线/副品牌命名、广告和具体规格需要复核。
- Parker Striped Duofold：`story-model-parker-striped-duofold-research`，明确提示条纹材料、Duofold 代际和版本需要来源。
- Parker Vacumatic：`story-model-parker-vacumatic-research`，明确提示 Vacumatic 机制、层纹材质、尺寸代际和 repair/anatomy 来源需要分层引用。
- Parker VP：`story-model-parker-vp-research`，明确提示可调笔尖概念、短命产品线位置和规格需要复核。
- Parker VS：`story-model-parker-vs-research`，明确提示 Vacumatic 到 Parker 51 之间的过渡位置、上墨和版本需要来源。
- Postal Reservoir Pen：`story-model-postal-reservoir-pen-research`，明确提示品牌实体暂缺，储墨结构和制造商归属不能冒充事实。
- Security Pen：`story-model-security-pen-research`，明确提示品牌实体暂缺，安全/防漏机制和结构概念需要专利、目录或 profile 复核。
- Wahl Pen：`story-model-wahl-pen-research`，明确提示 Wahl/Eversharp 边界、广告和规格需要复核。
- WASP Addipoint：`story-model-wasp-addipoint-research`，明确提示 Sheaffer/WASP 子品牌语境、Addipoint 可换笔尖概念和规格需要复核。
- WASP Clipper：`story-model-wasp-clipper-research`，明确提示子品牌语境、战前广告和版本需要来源。
- Wearever Zenith：`story-model-wearever-zenith-research`，明确提示平价市场定位、材料、广告和版本需要复核。
- Waterman C/F：`story-model-waterman-c-f-research`，明确提示早期墨水管/Cartridge-Filler 系统、接口和版本需要直接来源。
- Waterman Commando：`story-model-waterman-commando-research`，明确提示战时/实用语境、产品线位置和规格需要复核。
- Waterman Hundred Year Pen：`story-model-waterman-hundred-year-pen-research`，明确提示保修叙事、材料代际和版本需要来源。
- Waterman Ideal No. 52：`story-model-waterman-ideal-no52-research`，明确提示硬橡胶时代、编号体系、杠杆上墨和材质需要复核。
- Waterman Ideal No. 7：`story-model-waterman-ideal-no7-research`，明确提示彩色笔尖体系、大型号定位和版本需要来源。
- Waterman Ink-Vue：`story-model-waterman-ink-vue-research`，明确提示可视储墨机制、修复边界和版本需要分层引用。
- Waterman Patrician：`story-model-waterman-patrician-research`，明确提示高端定位、装饰性材料、颜色和规格需要复核。
- Waterman Taperite：`story-model-waterman-taperite-research`，明确提示半暗尖/锥形笔尖、战后语境和版本需要来源。
- Waterman X-Pen：`story-model-waterman-x-pen-research`，明确提示实验结构、名称来源和规格不能过度解读。
- Aurora 品牌泛称：`story-model-aurora-generic-research`，明确标记为待重分类/待拆分条目，不确认单一型号规格。
- Parker 51 中文经典页：`story-model-parker-51-vintage-cn-research`，明确标记为应与 The Parker 51 vintage 主档合并或建立别名，避免重复实体继续扩写。
- Pelikan M800 中文页：`story-model-pelikan-m800-cn-research`，明确标记为应与 Pelikan Souveran M800 主档合并或建立别名。
- Visconti Homo Sapiens：`story-model-visconti-homo-sapiens-research`，明确提示材料叙事、上墨系统、笔尖代际和价格需要产品页或评测来源。
...
- `/pen/白雪-fp20`、`/pen/百乐-pilot-78g-78g`、`/pen/百乐-pilot-912`、`/pen/百乐-pilot-capless-decimo`、`/pen/百乐-pilot-custom-823`、`/pen/百乐-pilot-elite-95s` 展示第八批优先型号研究队列档案、来源入口和入门/特殊尖/按动机制/真空上墨/短钢笔边界。
- `/pen/百乐-pilot-heritage-91`、`/pen/百乐-pilot-heritage-92`、`/pen/百乐-pilot-iroshizuku色彩雫`、`/pen/百乐-pilot-笑脸-kakuno`、`/pen/百利金-pelikan-m1000`、`/pen/百利金-pelikan-m605白乌龟` 展示第九批优先型号研究队列档案、来源入口和 Pilot/Pelikan 系列定位、待重分类墨水条目、尺寸/配色边界。
- `/pen/the-parker-vacumatic`、`/pen/the-parker-vp`、`/pen/the-postal-reservoir-pen`、`/pen/the-wasp-addipoint`、`/pen/the-wearever-zenith`、`/pen/waterman-s-c-f` 展示新增优先型号研究队列档案、来源入口和机制/品牌归属/子品牌/平价定位边界。
- `/pen/waterman-s-commando`、`/pen/waterman-s-hundred-year-pen`、`/pen/waterman-s-ideal-no52`、`/pen/waterman-s-ideal-no7`、`/pen/waterman-s-ink-vue`、`/pen/waterman-s-patrician`、`/pen/waterman-s-taperite`、`/pen/waterman-s-x-pen` 展示 Waterman 历史型号研究队列档案、来源入口和材料/上墨/版本边界。
- `/pen/奥罗拉-aurora`、`/pen/派克-parker-51-经典-vintage`、`/pen/百利金-pelikan-m800`、`/pen/维斯康蒂-visconti-homo-sapiens智人` 展示待重分类/待合并或待复核的型号档案，避免把泛称页和重复中文页误写成已确认的完整独立型号。
